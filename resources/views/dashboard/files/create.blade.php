...
@section('content')
    <div class="container mx-auto">
        <div class="bg-white rounded p-4 shadow m-4">
            <h1 class="text-2xl uppercase">Add a new file</h1>

            <form action="{{ route('dashboard.file.store') }}" class="mt-4" method="post"
                ...
                <div>
                    ...
                    <input type="url" class="form-control mt-2 @error('url') is-invalid @enderror"
                           placeholder="URL..." value="{{ old('url') }}" id="url" name="url" autofocus required/>
